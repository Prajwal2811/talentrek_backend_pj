                    ...
                    <div class="container-fluid mt-3">
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12">
                                ...
                                <form class="space-y-6" id="multiStepForm" action="{{ route('coach.registration.store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                        ...
                                        <div id="education-container" class="col-span-2 grid grid-cols-2 gap-4">
                                            ...
                                            <div class="education-entry grid grid-cols-2 gap-4 col-span-2 p-4 rounded-md relative border border-gray-300">
                                                ...
                                                <div>
                                                    ...
                                                    <input type="text" name="high_education[]" class="w-full border border-gray-300 rounded-md p-2"
                                                        value="{{ old("high_education.$i") }}" placeholder="Enter qualification">
                                                ...
                                                <div>
                                                    ...
                                                    <input type="text" name="field_of_study[]" class="w-full border border-gray-300 rounded-md p-2"
                                                        value="{{ old("field_of_study.$i") }}" placeholder="Enter field of study">
                                                ...
                                                <div>
                                                    ...
                                                    <input type="text" name="institution[]" class="w-full border border-gray-300 rounded-md p-2"
                                                        value="{{ old("institution.$i") }}" placeholder="Enter Institution name">
                                                    @error("institution.$i")
                                                    <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                                                    @enderror
                                                </div>
                                    ...
                                    <div id="step-3" class="step hidden" x-data="workExperience()">
                                        ...
                                        {{-- Add Work Button --}}
                                        <div class="col-span-2">
                                            <button type="button" class="text-green-600 text-sm mt-3" @click="addWork()">+ Add Work Experience</button>
                                        </div>
