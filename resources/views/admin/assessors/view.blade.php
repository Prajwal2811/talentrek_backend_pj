                    ...
                    <div class="block-header">
                        <div class="row clearfix align-items-center">
                            ...
                            <div class="col-xl-10 col-md-10 col-sm-12">
                                ...
                                <span>JustDo assessor's Profile</span>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card social theme-bg">
                                <div class="profile-header d-flex justify-content-between justify-content-center">
                                    <div class="d-flex">
                                        ...
                                        <div class="details">
                                            <h4 class="mb-0">{{ $assessor->name }}</h4>
                                            <span class="text-light">{{ $assessor->city }}</span>
                                    ...
                                    <div>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button class="btn btn-success" onclick="updateStatus({{ $assessor->id }}, 'approved', this)">Yes, Approve</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="modal fade text-dark" id="rejectModal" tabindex="-1">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                                                        <button class="btn btn-danger" onclick="submitRejection({{ $assessor->id }}, 'rejected', 'adminRejectionReason', this)">Yes, Reject</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="modal fade text-dark" id="superApproveModal" tabindex="-1">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                                                        <button class="btn btn-success" onclick="updateStatus({{ $assessor->id }}, 'superadmin_approved', this)">Yes, Approve</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="modal fade text-dark" id="superRejectModal" tabindex="-1">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                                                        <button class="btn btn-danger" onclick="submitRejection({{ $assessor->id }}, 'superadmin_rejected', 'superRejectionReason', this)">Yes, Reject</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <script>
                                            function updateStatus(assessorId, status, btn) {
                                                const originalText = btn.innerHTML;
                                                btn.disabled = true;
                                                btn.innerHTML = `<span class="spinner-border spinner-border-sm me-2" role="status" aria-hidden="true"></span>Processing...`;

                                                $.post('{{ route("admin.assessor.updateStatus") }}', {
                                                    _token: '{{ csrf_token() }}',
                                            ...
                                            function submitRejection(assessorId, status, reasonId, btn) {
                                    ...
                                    <form>
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 form-group">
                                                ...
                                                @php
                                                    $date = \Carbon\Carbon::parse($assessor->date_of_birth);
                                                    $day = $date->format('j');
                                                    $suffix = match (true) {
                        ...
                        <div class="col-xl-8 col-lg-8 col-md-7">
                            ...
                            <div class="card">
                                ...
                                <div class="body">
                                    <div class="col-lg-12">
                                        <div class="card-body">
                                            <p class="card-text">Here you can view the booking slots for this assessor.</p>
