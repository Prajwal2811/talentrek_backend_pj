                    ...
                    <div class="container mx-auto">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
                            ...
                            <div class="bg-white p-6 rounded-2xl shadow-md">
                                ...
                                <h2 class="text-3xl font-bold text-purple-600">150</h2>
                            </div>
                            <div class="bg-white p-6 rounded-2xl shadow-md">
                                <p class="text-gray-500">Expats</p>
                                <h2 class="text-3xl font-bold text-blue-500">90</h2>
                            </div>
                            <div class="bg-white p-6 rounded-2xl shadow-md">
                                <p class="text-gray-500">Coaches</p>
                                <h2 class="text-3xl font-bold text-red-500">70</h2>
                            </div>
                            <div class="bg-white p-6 rounded-2xl shadow-md">
                                <p class="text-gray-500">Mentors</p>
                                <h2 class="text-3xl font-bold text-yellow-500">85</h2>
                            </div>
                            <div class="bg-white p-6 rounded-2xl shadow-md">
                                <p class="text-gray-500">Assessors</p>
                                <h2 class="text-3xl font-bold text-red-500">45</h2>
                            </div>
                            <div class="bg-white p-6 rounded-2xl shadow-md">
                                <p class="text-gray-500">Training Material Sales</p>
                                <h2 class="text-3xl font-bold text-indigo-600">₹32,500</h2>
                            </div>
                            <div class="bg-white p-6 rounded-2xl shadow-md">
                            ...
                            <div class="bg-white p-6 rounded-2xl shadow-md">
                                ...
                                <h2 class="text-3xl font-bold text-pink-600">60</h2>
                            </div>
                        </div>
