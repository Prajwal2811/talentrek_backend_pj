        ...
        <div class="page-content">
            ...
            <section class="py-16 bg-white relative">
                    ...
                    <div class="chat-lists">
                        ...
                        <div id="admin" class="tab-content">
                            ...
                            <div class="chat-user" 
                                ...
                                <div class="chat-text">
                                    <div class="chat-name">Talentrek support
                ...
                <script>
                    ...
                    // ---------------------- Real-time Listening ----------------------
                    window.Echo.channel('chat.jobseeker')
                    ...
                    function loadUnreadCounts() {
                        $.get('/chat/unread-counts', function(counts) {
                            for (const type in counts) {
                                if(type === 'admin') {
                                    const badge = $('#unread-1-admin'); // Admin fixed ID
                                    const value = counts[type];
                                    if(value > 0) {
                                        badge.text(value).css({
                                            "background": "red",
                                            "color": "white",
                                            "border-radius": "50%",
                                            "padding": "2px 6px",
                                        ...
                                        badge.text('').removeAttr('style');
                                    }
                                } else {
                                    // Trainer/Mentor/Coach/Assessor
                                    const value = counts[type]; // currently single number per type
                                    // Apply to all spans of that type
                                    $(`span.unread-count[id$="-${type}"]`).each(function() {
                                        if(value > 0) {
                                            $(this).text(value).css({
                                                "background": "red",
                                                "color": "white",
