                        ...
                        <div>
                            ...
                            <div class="flex items-center mt-1 text-sm">
                                ...
                                <span class="ml-2 text-gray-600">({{ $avgRating }}/5) <span
                                        class="text-xs">{{ langLabel('rating') }}</span></span>
                            </div>
                        </div>
        ...
        <div class="max-w-6xl mx-auto p-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="grid grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <label class="block font-semibold mb-2">{{ langLabel('assessment_mode') }}</label>
            ...
            <div x-data="{ paymentMethod: 'card' }" class="space-y-4">
                ...
                <div x-show="paymentMethod === 'card'" class="space-y-2 border p-4 rounded bg-gray-50">
                    ...
                    <input type="text" placeholder="{{ langLabel('card_number') }}" maxlength="19"
                        class="w-full border rounded px-3 py-2 text-sm">
                    <div class="flex space-x-2">
                        <input type="text" placeholder="MM/YY" class="w-1/2 border rounded px-3 py-2 text-sm">
                        <input type="text" placeholder="{{ langLabel('cvv') }}" maxlength="4"
                ...
                <div>
                    ...
                    <div class="flex space-x-2">
                        <input type="text" id="couponCode" placeholder="{{ langLabel('enter_promocode_discount') }}"
                            class="w-full border rounded px-3 py-2 text-sm">
                ...
                <div class="border rounded p-4 space-y-2 mt-4">
                    ...
                    <div class="flex justify-between text-sm">
                        <span>{{ langLabel('tax') }} @if($taxType === 'percentage') ({{ $taxRate }}%) @endif</span>
