            ...
            <div class="max-w-7xl mx-auto flex flex-col lg:flex-row gap-8">
                ...
                <div class="flex-1">
                    ...
                    <section class="max-w-7xl mx-auto p-4">
                        <form method="POST" action="{{ route('session.booking-submit') }}" x-data="{ paymentMethod: '' }" id="coachBookingForm">
                            @csrf
                                ...
                                <div class="lg:col-span-2 space-y-6">
                                    ...
                                    <div class="grid grid-cols-2 gap-6 mb-6">
                                        <div>
                                            ...
                                            <label class="block font-semibold mb-2">{{ langLabel('coach_mode') }}</label>
                        ...
                        $(function () {
                            ...
                            $('#bookBtn').on('click', function(e) {
                                ...
                                if (!mode) {
                                    $('#modeSelect').after('<span class="text-red-500 error-message">Please select coach mode</span>');
                                    isValid = false;
                                }
                                if (!date) {
                        ...
                        function fetchSlots() {
                            ...
                            const mentorId = document.getElementById('coachIdInput').value;
                            ...
                            const url = `{{ route('get-coach-available-slots') }}?mode=${encodeURIComponent(mode)}&date=${encodeURIComponent(date)}&coach_id=${encodeURIComponent(mentorId)}`;
