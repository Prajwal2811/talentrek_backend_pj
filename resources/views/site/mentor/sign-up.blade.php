                        ...
                        <div class="row">
                            ...
                            <div class="container d-flex justify-content-center align-items-center min-vh-100">
                                <div class="w-full max-w-md px-6">
                                    ...
                                    <form class="space-y-4" action="{{ route('mentor.register.post') }}" method="POST">
                                        @csrf 
                                        <div>
                                            <label class="block text-sm mb-1">{{ langLabel('email') }}</label>
                                            <input type="email" name="email" placeholder="{{ langLabel('email') }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600" >
                                            @error('email')
                                        ...
                                        <div>
                                            ...
                                            <input type="text" name="phone_number" placeholder="{{ langLabel('mobile_no') }}" oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 9);" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600" >
                                            @error('phone_number')
                                                <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        ...
                                        <a href="{{ route('mentor.google.redirect') }}" 
                                        ...
                                        <div class="text-center text-sm mt-2">
                                            ...
                                            <a href="{{ route('mentor.login')}}" class="text-blue-600 hover:underline">{{ langLabel('sign_in') }}</a>
                                        </div>
                                    </form>
                                        <script>
