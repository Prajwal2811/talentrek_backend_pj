...
<body>
    ...
    <div class="loading-area">
       ...
       @php
        ...
        $subscriptions = App\Models\SubscriptionPlan::where('user_type', 'mentor')
            ->where('slug', 'mentor_standard')
            ->get();
    ...
    <!-- Subscription Modal -->
        <div id="subscriptionModal" class="fixed inset-0 bg-gray-200 bg-opacity-80 flex items-center justify-center z-50">
            <div class="bg-white w-full max-w-2xl p-5 rounded-xl shadow-lg relative"> {{-- Reduced max width from 5xl → 3xl --}}
