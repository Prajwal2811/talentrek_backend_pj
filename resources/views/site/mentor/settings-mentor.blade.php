                        ...
                        <section class="flex-1 p-6">
                            <div class="bg-white rounded-lg shadow p-6">
                                ...
                                <div x-show="activeSection === 'subscription'" x-transition class="bg-white p-6">
                                    ...
                                    @php
                                        $userId = auth()->id();
                                        $subscriptions = App\Models\SubscriptionPlan::where('user_type', 'mentor')->get();
                                        $purchasedSubscriptions = App\Models\PurchasedSubscription::select(
                                            ...
                                            ->where('subscription_plans.user_type', 'mentor')
                                                ...
                                                @foreach($subscriptions as $plan)
                                                    <div class="border rounded-lg p-4 shadow-sm text-center">
                                                        ...
                                                        <form action="{{ route('subscription.payment') }}" method="POST">
                                                            ...
                                                            <input type="hidden" name="user_id" value="{{ auth()->user('mentor')->id }}">
                                ...
                                <script>
                                    ...
                                    document.addEventListener('DOMContentLoaded', () => {
                                        ...
                                        document.getElementById('paymentForm').addEventListener('submit', function (e) {
                                            ...
                                            fetch("{{ route('mentor.subscription.payment') }}", {
                                                method: "POST",
                                        ...
                                        <div x-show="activeSubTab === 'personal'" x-transition>
                                            ...
                                            <form id="mentor-info-form" action="{{ route('mentor.profile.update') }}" method="POST">
                                                ...
                                                <div class="mt-3">
                                                    ...
                                                    <input type="text" name="address" value="{{ $mentor->address }}" class="w-full border rounded px-3 py-2" />
                                                    @error('address')
                                                ...
                                                <div class="mt-3">
                                                    ...
                                                    <input type="text" name="city" value="{{ $mentor->city }}" class="w-full border rounded px-3 py-2" />
                                                    @error('city')
                                                    <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="mt-3">
                                                    ...
                                                    <input type="text" name="state" value="{{ $mentor->state }}" class="w-full border rounded px-3 py-2" />
                                                    @error('state')
                                                    <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="mt-3">
                                                    ...
                                                    <input type="text" name="country" value="{{ $mentor->country }}" class="w-full border rounded px-3 py-2" />
                                                    @error('country')
                                                    <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="mt-3">
                                                    ...
                                                    <input type="text" name="pin_code" value="{{ $mentor->pin_code }}" class="w-full border rounded px-3 py-2" />
                                                    @error('pin_code')
                                                    <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                                                    @enderror
                                                </div>
                                                ...
                                                <h3 class="text-2xl font-bold mt-5">Session Price</h3>
                                                    ...
                                                    <div class="grid grid-cols-2 gap-6 mt-3">
                                                        ...
                                                        <div>
                                                            ...
                                                            <input type="text" name="per_slot_price" value="{{ $mentor->per_slot_price }}" class="w-full border rounded px-3 py-2" />
                                                        </div>
                                                    </div>
