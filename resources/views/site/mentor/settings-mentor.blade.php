                                    ...
                                    <div>
                                        ...
                                        <form class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                                ...
                                                <div class="md:col-span-2">
                                                    ...
                                                    <input type="text" value="XYZ Infotech" class="w-full border rounded px-3 py-2" />
                                                </div>

                                                <div>
                                                    <label class="block mb-1 font-medium">Company Phone number</label>
                                                    <input type="text" value="+614 616161564" class="w-full border rounded px-3 py-2" />
                                                </div>

                                                <div>
                                                    <label class="block mb-1 font-medium">Company email</label>
                                                    <input type="email" value="xyzinfotech@gmail.com" class="w-full border rounded px-3 py-2" />
                                                </div>
                                                ...
                                                <div>
                                                    ...
                                                    <input type="text" value="2015-08-15" class="w-full border rounded px-3 py-2" />
                                                </div>

                                                <div>
                                                    <label class="block mb-1 font-medium">Company website</label>
                                                    <input type="text" value="www.xyzinfotech.com" class="w-full border rounded px-3 py-2" />
                                                </div>
                                                </form>
