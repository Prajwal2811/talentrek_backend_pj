        ...
        <div class="flex-1 flex flex-col">
            ...
            <main class="p-6 bg-gray-100 flex-1 overflow-y-auto" x-data="dashboard()">
                ...
                <div class="grid grid-cols-2 gap-4 mb-6">
                    ...
                    <div class="bg-white p-6 rounded-lg shadow">
                        <p class="text-gray-500">{{ langLabel('todays_session') }}</p>
                ...
                <div x-data="sessionManager()" class="bg-white p-6 rounded-lg shadow relative">
                    ...
                    <div class="flex space-x-6 border-b mb-4 text-sm font-medium text-gray-600">
                        ...
                        <button @click="switchTab('cancelled')" :class="tabClass('cancelled')">{{ langLabel('cancelled_sessions') }}</button>
                        <button @click="switchTab('completed')" :class="tabClass('completed')">{{ langLabel('completed_sessions') }}</button>
                    </div>
                    <!-- Session List -->
                        ...
                        <form id="basic-form" method="POST" novalidate action="{{ route('mentor.dashboard-action') }}">
                            ...
                            <div class="bg-white rounded-lg shadow-lg w-full max-w-3xl p-6 relative">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-end mb-6">
                                    ...
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-1">{{ langLabel('seelct_session_time') }}</label>
                                        <select x-model="newTime"
                                            :disabled="postponeSession !== 'Yes'"
                                            class="w-full border border-gray-300 rounded-md p-2 text-sm">
                                            <option value="">{{ langLabel('select_timing') }}</option>
                                            @if($slots->isEmpty())
