                                    ...
                                    <div id="step-5" class="step hidden">
                                        ...
                                        <div>
                                            <label class="block text-sm font-medium mb-1">
                                                Upload resume <span style="color: red; font-size: 17px;">*</span>
                                            </label>
                                        ...
                                        <div>
                                            <label class="block text-sm font-medium mb-1 mt-3">
                                                Upload profile picture <span style="color: red; font-size: 17px;">*</span>
                                            </label>
                                            <div class="flex gap-2 items-center">
                                        ...
                                        <div>
                                            <label class="block text-sm font-medium mb-1 mt-3">
                                                Upload training certificate <span style="color: red; font-size: 17px;">*</span>
                                            </label>
                                            <div class="flex gap-2 items-center">
                                                <input type="file" name="training_certificate" accept=".pdf,.jpg,.jpeg,.png" class="border rounded-md p-2 w-full text-sm mt-1" />
                                            </div>
