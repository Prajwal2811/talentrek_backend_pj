<div x-show="activeSection === 'subscription'" x-transition class="bg-white p-6">
    ...
    <div id="plansModal" class="fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center z-50 hidden">
        <div class="bg-white w-full max-w-2xl p-6 rounded-lg shadow-lg relative overflow-y-auto max-h-[90vh]">
            ...
            <h3 class="text-2xl font-semibold mb-6 text-center">{{ langLabel('available_subscription_plans') }}</h3>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-1 gap-6">
                @foreach($subscriptions as $plan)
                    ...
                    <div class="border rounded-xl p-5 shadow-sm hover:shadow-md transition-all duration-200 bg-white text-center">
