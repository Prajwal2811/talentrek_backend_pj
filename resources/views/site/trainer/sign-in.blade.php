                                ...
                                <form method="POST" action="{{ route('trainer.login.submit') }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="text-right mt-1">
                                            <a href="{{ route('trainer.forget.password')}}" class="text-sm text-blue-600 hover:underline">Forgot password?</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="text-center text-sm">
                                        ...
                                        <a href="{{ route('trainer.signup')}}" class="text-blue-600 hover:underline">Sign up</a>
                                    </div>
                                </form>
