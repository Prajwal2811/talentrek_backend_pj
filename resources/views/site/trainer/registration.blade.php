                                ...
                                <form class="space-y-6" id="multiStepForm" action="{{ route('trainer.registration.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div id="step-1" class="step">
                                        ...
                                        <div class="grid grid-cols-2 gap-6">
                                            <div>
                                                ...
                                                <input placeholder="{{ langLabel('enter_phone_number') }}" name="phone_number" type="tel" class="w-2/3 border rounded-r-md p-2" value="{{old('phone_number')}}"/>
                                        ...
                                        <div class="flex justify-end mt-3">
                                            <button type="button" onclick="showStep(2)" class="bg-blue-700 text-white px-6 py-2 rounded-md">{{ langLabel('next') }}</button>
                                        </div>
                                    ...
                                    <div id="step-2" class="step hidden">
                                        ...
                                        <div class="col-span-2">
                                            <button type="button" id="add-education" class="text-green-600 text-sm mt-3">+ {{ langLabel('add_more_education') }}</button>
                                        </div>
                                   ...
                                   <div id="step-3" class="step hidden" x-data="workExperience()">
                                        ...
                                        <div id="work-container" class="col-span-2 grid grid-cols-2 gap-4">
                                            ...
                                            <template x-for="(work, index) in workList" :key="index">
                                                <div class="work-entry grid grid-cols-2 gap-4 col-span-2 p-4 rounded-md relative border border-gray-300">
                                                    ...
                                                    {{-- Job Role --}}
                                                    <div>
                                                        <label class="block text-sm font-medium text-gray-700 mb-1">{{ langLabel('job_role') }} <span style="color: red; font-size: 17px;">*</span></label>
                                                    ...
                                                    {{-- Start Date --}}
                                                    <div>
                                                        <label class="block text-sm font-medium text-gray-700 mb-1">{{ langLabel('started_from') }} <span style="color: red; font-size: 17px;">*</span></label>
                                        ...
                                        {{-- Add Work Button --}}
                                        <div class="col-span-2">
                                            <button type="button" class="text-green-600 text-sm mt-3" @click="addWork()">+ {{ langLabel('add_work_experience') }}</button>
                                        </div>
                                    ...
                                    <div id="step-4" class="step hidden">
                                        ...
                                        <div>
                                            <label class="block mb-1 text-sm font-medium mt-3">{{ langLabel('training_skills') }} <span style="color: red; font-size: 17px;">*</span></label>
                                    ...
                                    <div id="step-5" class="step hidden">
                                        ...
                                        <div>
                                            ...
                                            <div class="flex gap-2 items-center">
                                                <input type="file" name="profile_picture" accept="image/*" class="border rounded-md p-2 w-full text-sm mt-1" />
                                            </div>
                                        ...
                                        <div>
                                            ...
                                            <div class="flex gap-2 items-center">
                                                <input type="file" name="training_certificate" accept="application/pdf,image/*" class="border rounded-md p-2 w-full text-sm mt-1" />
                                            </div>
                                        ...
                                        <div class="text-sm mt-3">
                                            ...
                                            <span>
                                                ...
                                                <ul class="list-disc ml-5 mt-1 space-y-1 text-gray-700">
                                                    <li>Trainers must create an account to publish courses.</li>
                                                    <li>Uploaded content must be original or properly licensed.</li>
                                                    <li>Trainers are responsible for course quality and accuracy.</li>
