    ...
    <div x-data="{ activeSubTab: 'personal' }">
        ...
        <div>
            ...
            <div x-show="activeSubTab === 'personal'" x-transition>
                ...
                <form id="trainer-info-form" action="{{ route('trainer.profile.update') }}" method="POST">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" value="{{ $trainerSkills->name ?? '' }}" placeholder="John Doe"
                    ...
                    <div class="grid grid-cols-2 gap-6 mt-3">
                        ...
                        <div>
                            ...
                            <input type="email" name="email" value="{{ $trainerSkills->email ?? '' }}"
                                placeholder="john.doe@example.com" class="w-full border rounded px-3 py-2" />
                            @error('email')
                                <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        <div>
                            <label class="block mb-1 text-sm font-medium mt-3">Gender <span
                    ...
                    <div class="grid grid-cols-2 gap-6 mt-3">
                        ...
                        <div>
                            ...
                            <input type="text" name="phone" value="{{ $trainerSkills->phone_number ?? '' }}"
                                placeholder="+91 9876543210" class="w-full border rounded px-3 py-2" />
                            @error('phone')
                                <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="date" name="dob" value="{{ $trainerSkills->date_of_birth ?? '' }}"
                                class="w-full border rounded px-3 py-2" />
                            @error('dob')
                                <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="grid grid-cols-2 gap-6 mt-3">
                        <div>
                            ...
                            <input type="text" name="national_id" id="national_id"
                                class="w-full border rounded-md p-2 mt-1" placeholder="Enter national id number"
                                value="{{ $trainerSkills->national_id ?? '' }}" maxlength="15"
                    ...
                    <div class="md:col-span-2 mt-3">
                        ...
                        <textarea name="address" placeholder="Enter address"
                            class="w-full border rounded px-3 py-2">{{ $trainerSkills->address ?? '' }}</textarea>
                        @error('address')
                            <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mt-3">
                        ...
                        <input type="text" name="city" value="{{ $trainerSkills->city }}"
                            class="w-full border rounded px-3 py-2" />
                        @error('city')
                            <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="mt-3">
                        ...
                        <input type="text" name="state" placeholder="Enter State" value="{{ $trainerSkills->state }}"
                            class="w-full border rounded px-3 py-2" />
                        @error('state')
                            <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="mt-3">
                        ...
                        <input type="text" name="country" value="{{ $trainerSkills->country }}"
                            class="w-full border rounded px-3 py-2" />
                        @error('country')
                            <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="mt-3">
                        ...
                        <input type="text" name="pin_code" value="{{ $trainerSkills->pin_code }}"
                            class="w-full border rounded px-3 py-2" />
                        @error('pin_code')
                            <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="mt-6 flex justify-end space-x-3">
                        <button @click.prevent="activeSubTab = 'education'"
                            class="border px-6 py-2 rounded hover:bg-gray-100">
                            Next
                        </button>
                        <button type="button" id="save-trainer-info"
            ...
            <div x-show="activeSubTab === 'education'" x-transition>
                ...
                <!-- Education Form -->
                <form id="education-info-form" method="POST" action="{{ route('trainer.education.update') }}"
                    class="space-y-6">
                    @csrf
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input type="text" name="high_education[]"
                                            ...
                                            class="w-full border rounded px-3 py-2" placeholder="e.g., Bachelor's Degree" />
                                    </div>
                                    <div>
                                        ...
                                        <input type="text" name="field_of_study[]"
                                            ...
                                            class="w-full border rounded px-3 py-2" placeholder="e.g., Computer Science" />
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input type="text" name="institution[]" value="{{ $education->institution }}"
                                            class="w-full border rounded px-3 py-2" placeholder="e.g., ABC University" />
                                    </div>
                                    <div>
                                        <label class="block mb-1 font-medium">Graduation Year</label>
                                        <input type="number" name="graduate_year[]" value="{{ $education->graduate_year }}"
                                            class="w-full border rounded px-3 py-2" placeholder="e.g., 2023" min="1900"
                                            max="2099" oninput="this.value = this.value.replace(/[^0-9]/g, '')" />
                                    </div>
                                </div>
                ...
                <!-- Submit Buttons -->
                <div class="mt-6 flex justify-end space-x-3">
                    <button @click.prevent="activeSubTab = 'work'"
                        class="border px-6 py-2 rounded hover:bg-gray-100">Next</button>
            ...
            <div x-show="activeSubTab === 'work'" x-transition>
                ...
                <form id="work-info-form" method="POST" action="{{ route('trainer.workexprience.update')}}"
                    class="space-y-6">
                    @csrf
                            ...
                            <div class="work-entry border border-gray-300 rounded-md p-4 space-y-4 relative">
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input type="text" name="job_role[]" value="{{ $work->job_role }}"
                                            class="w-full border rounded px-3 py-2" placeholder="e.g., Software Engineer" />
                                    </div>
                                    <div>
                                        <label class="block mb-1 font-medium">Organization</label>
                                        <input type="text" name="organization[]" value="{{ $work->organization }}"
                                            class="w-full border rounded px-3 py-2" placeholder="e.g., XYZ Corp" />
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input type="date" name="starts_from[]"
                                            value="{{ \Carbon\Carbon::parse($work->starts_from)->format('Y-m-d') }}"
                                            class="w-full border rounded px-3 py-2" />
                                    </div>
                                    <div>
                                        <label class="block mb-1 font-medium">To</label>
                                        <input type="date" name="end_to[]"
                                            value="{{ !is_null($work->end_to) && $work->end_to !== 'Work here' ? \Carbon\Carbon::parse($work->end_to)->format('Y-m-d') : '' }}"
                                            class="w-full border rounded px-3 py-2" {{ is_null($work->end_to) || $work->end_to === 'Work here' ? 'disabled' : '' }} />

                                        <label class="inline-flex items-center mt-2">
                                            <input type="checkbox" name="currently_working[{{ $loop->index }}]" value="1"
                                                onchange="toggleEndDate(this)" {{ is_null($work->end_to) || $work->end_to === 'Work here' ? 'checked' : '' }} />
                    ...
                    <div class="mt-6 flex justify-end space-x-3">
                        <button @click.prevent="activeSubTab = 'skills'"
                            class="border px-6 py-2 rounded hover:bg-gray-100">Next</button>
                        <button type="submit"
                            class="bg-blue-600 text-white px-6 py-2 rounded hover:bg-blue-700">Save</button>
                    </div>
                ...
                <form id="trainer-skills-info-form" method="POST" action="{{ route('trainer.skill.update') }}">
                    ...
                    <div x-show="activeSubTab === 'skills'" x-cloak class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="training_skills"
                                placeholder="E.g., JavaScript, UI/UX, Communication"
                                class="w-full border rounded px-3 py-2"
            ...
            <div x-show="activeSubTab === 'additional'" x-transition>
                ...
                <form id="trainer-additional-info-form" method="POST" action="{{ route('trainer.additional.update') }}"
                    ...
                    <div x-show="activeSubTab === 'additional'" x-cloak class="space-y-4 text-sm">
                                ...
                                @if($resume)
                                    <div class="flex items-center gap-4">
                                        ...
                                        <button type="button" class="delete-file text-red-600 text-sm"
                                            data-type="resume">Delete</button>
                                    </div>
                                @endif
                                ...
                                @if($profile)
                                    <div class="flex items-center gap-4">
                                        <a href="{{ asset($profile->document_path) }}" target="_blank"
                                            class="bg-green-600 text-white px-3 py-1.5 text-xs rounded hover:bg-green-700">📄
                                            View Profile</a>
                                        <button type="button" class="delete-file text-red-600 text-sm"
                                            data-type="profile_picture">Delete</button>
                                    </div>
                                @endif
                        ...
                        <div>
                            ...
                            <div class="flex flex-col gap-2">
                                @if($certificate)
                                    <div class="flex items-center gap-4">
                                        <a href="{{ asset($certificate->document_path) }}" target="_blank"
                                            class="bg-purple-600 text-white px-3 py-1.5 text-xs rounded hover:bg-purple-700">📄
                                            View Certificate</a>
                                        <button type="button" class="delete-file text-red-600 text-sm"
                                            data-type="training_certificate">Delete</button>
                                    </div>
                                @endif
                                <input type="file" name="training_certificate" accept=".pdf,.jpg,.jpeg,.png"
                                    class="border rounded p-2 w-full" />
                            </div>
                        </div>
                        ...
                        <div class="flex justify-end mt-6">
                            <button type="button" id="save-trainer-additional-info"
                                class="bg-blue-700 text-white px-6 py-2 rounded hover:bg-blue-800">Save</button>
                        </div>
                    </div>
                </form>
            </div>
            <!-- Delete Confirmation Modal -->
            <div id="trainerDeleteConfirmModal"
                ...
                <div class="bg-white rounded p-6 w-full max-w-sm shadow-lg">
                    ...
                    <p class="text-gray-700 mb-6">Are you sure you want to delete <span id="trainer-delete-file-type"
                            class="font-semibold"></span>?</p>
                    <div class="flex justify-end gap-4">
                        <button type="button" id="trainerCancelDeleteBtn"
                            class="px-4 py-2 bg-gray-200 hover:bg-gray-300 rounded">Cancel</button>
                        <button type="button" id="trainerConfirmDeleteBtn"
                            class="px-4 py-2 bg-red-600 text-white hover:bg-red-700 rounded">Yes, Delete</button>
                    </div>
                </div>
            </div>
