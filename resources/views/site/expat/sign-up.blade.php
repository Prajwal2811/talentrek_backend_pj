                        ...
                        <div class="row">
                            ...
                            <div class="container d-flex justify-content-center align-items-center min-vh-100">
                                <div class="w-full max-w-md px-6">
                                    ...
                                    <form class="space-y-4" action="{{ route('expat.register.post') }}" method="POST">
                                        @csrf 
                                        <input type="hidden" name="role" value="expat">
                                        ...
                                        <a href="{{ route('jobseeker.google.redirect') }}" type="button" class="w-full flex items-center justify-center gap-2 border border-gray-300 py-2 rounded-md hover:bg-gray-100">
                                            ...
                                            <span>{{ langLabel('signin_google') }}</span>
                                        </a>
                                        ...
                                        <div class="text-center text-sm mt-2">
                                            ...
                                            <a href="{{ route('signin.form')}}" class="text-blue-600 hover:underline">{{ langLabel('sign_in') }}</a>
                                        </div>
                                    </form>
                                        <script>
