...
<div x-show="tab === 'training'" x-cloak>
                    ...
                    <div class="dropdown">
                        @if($assessment)
                            ...
                            <ul class="dropdown-menu" aria-labelledby="assessmentDropdown{{ $assessment->id }}">
                                ...
                                @else
                                    <li>
                                        <a class="dropdown-item text-blue-600" href="{{ $batchData->zoom_join_url }}" target="_blank">
                                            Join Training
                                        </a>
                                    </li>
                                @endif
    ...
    @empty
            <p class="text-gray-500 text-sm">You have not enrolled in any trainings yet.</p>
    @endforelse
</div>
