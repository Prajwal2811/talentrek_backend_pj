                    ...
                    <div class="w-4/5 space-y-6">
                        ...
                        <div x-show="tab === 'profile'" x-cloak 
                            ...
                            <div class="space-y-4 mt-4">
                                ...
                                <!-- Personal Info -->
                                <form id="personal-info-form" action="{{ route('expat.profile.update') }}" method="POST">
                                    @csrf
                                ...
                                <!-- Education Form -->
                                <form id="education-info-form" method="POST" action="{{ route('expat.education.update') }}">
                                    @csrf    
                            ...
                            <!-- Work Experience Success Message -->
                                ...
                                <form id="work-info-form" method="POST" action="{{ route('expat.workexprience.update') }}">
                                    @csrf
                            ...
                            <!-- Skills Success Message -->
                                ...
                                <form id="skills-info-form" method="POST" action="{{ route('expat.skill.update') }}">
                                    @csrf
                                ...
                                <form id="additional-info-form" method="POST" action="{{ route('expat.additional.update') }}" enctype="multipart/form-data">
                                    @csrf
                                ...
                                <script>
                                    document.addEventListener('DOMContentLoaded', function () {
                                        ...
                                        document.getElementById('confirmDeleteBtn')?.addEventListener('click', function () {
                                            ...
                                            const url = `{{ route('expat.additional.delete', ':type') }}`.replace(':type', selectedFileType);
                                            ...
                                            <div class="dropdown">
                                                @if($assessment)
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="assessmentDropdown{{ $assessment->id }}">
                                                        @if ($assessmentTaken)
                                                            <li>
                                                                <a class="dropdown-item text-green-600" href="{{ route('expat.assessment.result', $assessment->id) }}">
                                                                    View Score
                                                                </a>
                                                            </li>
                    ...
                    <div x-show="tab === 'subscription'" x-cloak>
                        ...
                        @php
                            ...
                            $purchasedSubscriptions = App\Models\PurchasedSubscription::select(
                                ...
                                ->where('subscription_plans.user_type', 'expat')
