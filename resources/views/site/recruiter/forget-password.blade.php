                        ...
                        <div class="row">
                            ...
                            <div class="container d-flex justify-content-center align-items-center min-vh-100">
                                <div class="w-full max-w-sm p-6">
                                    ...
                                    <form action="{{ route('recruiter.submit.forget.password') }}" method="POST">
                                        @csrf
                                        <div class="mb-4">
                                            <label for="contact" class="block text-sm font-medium mb-1">{{ langLabel('email') }} / {{ langLabel('mobile_no') }}</label>
                                            <input type="text" name="contact" id="contact" placeholder="{{ langLabel('enter_email_mobile') }}"
                                                value="{{ old('contact') }}"
