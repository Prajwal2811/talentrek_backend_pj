        ...
        <div class="flex h-screen">
            ...
            <div class="flex-1 flex flex-col">
                @include('site.assessor.componants.navbar')
                    ...
                    <main class="p-6 bg-gray-100 flex-1 overflow-y-auto">{{ langLabel('Payment') }}
                        ...
                        <div class="bg-white rounded-lg shadow p-4 flex flex-col h-[600px]">
                            ...
                            <div class="flex items-center space-x-4 border-b pb-4 mb-4">
                                ...
                                <div>
                                    <h3 class="text-md font-semibold">{{ langLabel('admin_support') }} Talentrek</h3>
                            ...
                            <div class="pt-4 mt-4 border-t flex items-center space-x-2">
                                <input
                                    type="text"
                                    id="chatInput"
                                    placeholder="{{ langLabel('write_your_message') }}..."
                    ...
                    <script>
                        ...
                        $(document).ready(function () {
                            $.ajax({
                                url: "{{ route('assessor.group.chat.fetch') }}",
                                method: "GET",
