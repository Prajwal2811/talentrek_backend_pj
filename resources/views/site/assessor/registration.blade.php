                                    ...
                                    <div id="step-2" class="step hidden">
                                        ...
                                        <div id="education-container" class="col-span-2 grid grid-cols-2 gap-4">
                                            ...
                                            <div class="education-entry grid grid-cols-2 gap-4 col-span-2 p-4 rounded-md relative border border-gray-300">
                                                ...
                                                <div>
                                                    <label class="block text-sm font-medium text-gray-700 mb-1">Highest qualification <span style="color: red;">*</span></label>
                                                ...
                                                <div>
                                                    <label class="block text-sm font-medium text-gray-700 mb-1">Field of study <span style="color: red;">*</span></label>
                                                ...
                                                <div>
                                                    <label class="block text-sm font-medium text-gray-700 mb-1">Institution name <span style="color: red;">*</span></label>
