                                    ...
                                    <div class="flex-1">
                                        ...
                                        <div class="flex items-center space-x-4">
                                            ...
                                            <div class="inline-flex items-center border border-gray-300 rounded px-3 py-2 space-x-6">
                                                <button type="button" onclick="decreaseCount()" class="text-gray-600 text-lg">◀</button>
                                                <span id="memberCount" class="text-base font-semibold text-gray-800">1</span>
                                                <button type="button" onclick="increaseCount()" class="text-gray-600 text-lg">▶</button>
                                            </div>
                                        </div>

                                        <!-- Hidden input so member count is sent with form -->
                                        <input type="hidden" name="member_count" id="memberCountInput" value="1">
