                    ...
                    <div class="flex"> 
                        ...
                        <section class="flex-1 p-6">
                            <div class="bg-white rounded-lg shadow p-6">
                                @include('site.coach.profile.profile')
                                @include('site.coach.profile.notification')
                                @include('site.coach.profile.subscription')
                                @include('site.coach.profile.delete')
                                @include('site.coach.profile.payment')
                                @include('site.coach.profile.privacy')
