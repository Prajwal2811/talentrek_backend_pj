...
>
  ...
  <!-- Navigation -->
    <nav 
        ...
        <!-- About coach -->
        <a 
            href="about-coach.html" 
            :class="[
            active === 'about-coach.html' 
                ? 'bg-white text-blue-900 font-semibold' 
                : 'hover:bg-white hover:text-blue-900',
            'flex items-center px-4 py-2 rounded-md transition-colors duration-200'
            ]"
        ...
        <div x-data="{ open: false }" class="flex flex-col">
            ...
            <a 
                href="manage-booking-slots-coach.html" 
                :class="[
            ...
            <a 
                href="create-booking-slots-coach.html" 
                :class="[
        ...
        <!-- Chat with Jobseeker -->
        <a 
            href="chat-jobseeker-coach.html" 
            :class="[
