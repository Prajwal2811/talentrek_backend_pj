<?php
    ...
    $coachImage = App\Models\AdditionalInfo::where('doc_type', 'coach_profile_picture')
                                    ...
                                    <div class="flex-1 p-4 space-y-3 overflow-y-auto bg-white h-[calc(100vh-280px)] scroll-hidden"
                                        ...
                                        <template x-for="(message, i) in activeContact?.messages || []" :key="i">
                                            <div class="flex items-end gap-2" :class="message.sender === 'me' ? 'justify-end' : 'justify-start'">
                                                ...
                                                <!-- Right avatar -->
                                                <img x-show="message.sender === 'me'" :src="coachImage"
                                                    class="w-8 h-8 rounded-full object-cover" alt="coach">
                                            </div>
                                        </template>
                                    </div>
...
.file-name {
    ...
    text-overflow: ellipsis;
                        ...
                        <script>
                            function chatApp() {
                                return {
                                    coachImage: "{{ $coachImage->document_path ?? 'https://via.placeholder.com/40' }}", // ✅ coach ki profile
                                    contacts: [],
                                    activeContact: null,
                                    newMessage: '',
                                    selectedFile: null,
