                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6">
                            <div class="container d-flex justify-content-center align-items-center min-vh-100">
                             <div class="w-full max-w-sm p-6">
                                ...
                                <form method="POST" action="{{ route('coach.login.submit') }}">
                                    @csrf
                                    <div class="mb-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="text-right mt-1">
                                            <a href="{{ route('coach.forget.password')}}" class="text-sm text-blue-600 hover:underline">{{ langLabel('forgot_password') }}</a>
                                        </div>
                                    </div>
                                    ...
                                    <a href="{{ route('coach.google.redirect') }}" 
                                    ...
                                    <div class="text-center text-sm">
                                        ...
                                        <a href="{{ route('coach.signup')}}" class="text-blue-600 hover:underline">{{ langLabel('register') }}</a>
                                    </div>
                                </form>
