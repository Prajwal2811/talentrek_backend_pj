            ...
            <div class="lg:col-span-2 space-y-4">
                ...
                @empty
                    <div class="text-center py-16">
                        {{-- <img src="{{ asset('images/empty-cart.svg') }}" alt="Empty Cart" class="w-40 mx-auto mb-4 opacity-80"> --}}
                        <p class="text-gray-500 mb-4">Your cart is empty.</p>
                        <a href="{{ route('training') }}" class="inline-block bg-blue-600 text-white px-5 py-2 rounded hover:bg-blue-700">
                            Browse Trainings
                        </a>
                    </div>
                @endforelse
...
<div id="removeConfirmModal" class="fixed top-20 left-0 right-0 flex justify-center z-50 hidden">
    <div class="bg-white border border-gray-300 rounded-lg shadow-lg p-6 w-full max-w-sm text-center">
        ...
        <p class="text-gray-600 mb-6">Are you sure you want to remove this course from your cart?</p>
        <div class="flex justify-center space-x-4">
            <button id="cancelRemove" class="bg-gray-300 hover:bg-gray-400 text-gray-700 px-4 py-2 rounded">Cancel</button>
            <button id="confirmRemove" class="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded">Remove</button>
        </div>
    </div>
</div>
