                            ...
                            <div class="container d-flex justify-content-center align-items-center min-vh-100">
                             <div class="w-full max-w-sm p-6">
                                ...
                                <form method="POST" action="{{ route('jobseeker.login.submit') }}">
                                    ...
                                    <a href="{{ route('jobseeker.google.redirect') }}" class="w-full flex items-center justify-center py-2.5 border border-gray-300 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-50 mb-3">
