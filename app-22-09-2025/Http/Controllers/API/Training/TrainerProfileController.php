...
class TrainerProfileController extends Controller
{
    ...
    public function updatePersonalInfoDetails(Request $request)
    {
        ...
        $rules = [
            ...
            'pincode' => 'required',                
            'phone_code' => 'required',                
            'phone_number' => 'required|unique:trainers,phone_number,' . $Trainers->id,
            ...
            'national_id' => [
                ...
                function ($attribute, $value, $fail) use ($Trainers) {
                    $existsInTrainers = Trainers::where('national_id', $value)
        ...
        try {
            ...
            $this->notifications->addAdminNotification([
                ...
                'sender_type' => 'Trainer profile updated successfully',
    ...
    public function updateEducationInfoDetails(Request $request)
    {
        ...
        try {
            ...
            $this->notifications->addAdminNotification([
                ...
                'sender_type' => 'Trainer education details updated successfully',
                'receiver_id' => 1, // admin user
                'message'     => ' Trainer education details updated successfully.',
                'user_type'   => 'trainer'
            ]);
    ...
    public function updateWorkExperienceInfoDetails(Request $request)
    {
        try {
            ...
            $this->notifications->addAdminNotification([
                'sender_id'   => $TrainersId,
                'sender_type' => 'Trainer experiance details updated successfully',
                'receiver_id' => 1, // admin user
                'message'     => ' Trainer experiance details updated successfully.',
                'user_type'   => 'trainer'
            ]);
    ...
    public function updateSkillsInfoDetails(Request $request)
    {
        try {
            ...
            $this->notifications->addAdminNotification([
                'sender_id'   => $TrainersId,
                'sender_type' => 'Trainer skills details updated successfully',
                'receiver_id' => 1, // admin user
                'message'     => ' Trainer skills details updated successfully.',
                'user_type'   => 'trainer'
            ]);
    ...
    public function updateAdditionalInfoDetails(Request $request)
    {
        try {
            ...
            $this->notifications->addAdminNotification([
                'sender_id'   => $TrainersId,
                'sender_type' => 'Trainer Additional info details updated successfully',
                'receiver_id' => 1, // admin user
                'message'     => ' Trainer Additional info details updated successfully.',
                'user_type'   => 'trainer'
            ]);
