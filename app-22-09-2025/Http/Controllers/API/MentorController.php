        ...
        try {
           ...
           $validator = Validator::make($request->all(), [
            ...
            $this->notifications->addAdminNotification([
                ...
                'message'     => 'Welcome to Talentrek – Mentor registration Successful by App' . $jobseeker->name,
                'user_type'   => 'mentor'
            ]);
    ...
    public function registration(Request $request)
    {
        ...
        try {
            ...
            $rules = [
                ...
                'gender' => 'required|in:Male,Female,Other',
                'mobile' => 'required|unique:mentors,phone_number,' . $trainer->id,
                ...
                'national_id' => [
                    ...
                    function ($attribute, $value, $fail) use ($trainer) {
                        $existsInTrainers = Mentors::where('national_id', $value)
                            ->where('id', '!=', $trainer->id)
                            ->exists();
