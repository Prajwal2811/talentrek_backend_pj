...
class TrainerController extends Controller
{
    ...
    public function signUp(Request $request)
    {
        try {
            ...
            $this->notifications->addAdminNotification([
                ...
                'message'     => 'Welcome to Talentrek – Trainer registration Successful by App' . $jobseeker->name,
                'user_type'   => 'trainer'
            ]);
    ...
    public function registration(Request $request)
    {
        ...
        try {
            ...
            $trainer = Trainers::where('email', $request->email)
            ...
            $rules = [
                ...
                'gender' => 'required|in:Male,Female,Other',
                'mobile' => 'required|unique:trainers,phone_number,' . $trainer->id,
    ...
    public function verifyOtpTrainer(Request $request)
    {
        $validator = Validator::make($request->all(), [
            'email' => 'nullable|email|exists:Trainers,email',
            'phone_number' => 'nullable|string|exists:Trainers,phone_number',
