...
class ExplorerController extends Controller
{
    ...
    public function trainingList()
    {
        try {
            ...
            $trainingMaterials = TrainingMaterial::select('id', 'trainer_id', 'training_title', 'training_price', 'training_offer_price', 'thumbnail_file_path')
    ...
    public function mentorsExplorerList()
    {
        try {
            ...
            $mentorsList = Mentors::select('id', 'name', 'email', 'phone_code', 'phone_number', 'date_of_birth', 'city')
                ->addSelect(DB::raw("'UI UX Designer' as designation"))
                ->with('WorkExperience')
                ->withAvg('mentorReviews', 'ratings')
                ->get()
                ->map(function ($item) {
    ...
    public function mentorDetailById($mentorId)
    {
        try {
            ...
            $MentorsDetails = Mentors::select('*')
                ->with(['mentorReviews', 'WorkExperience', 'mentorEducations'])
                ->withAvg('mentorReviews', 'ratings')
                ->where('id', $mentorId)
                ->first();
    ...
    public function assesserDetailById($assessorId)
    {
        try {
            $AssessorDetails = Assessors::select('*')
                ->with(['assessorReviews', 'assessorEducations', 'WorkExperience'])
                ->withAvg('assessorReviews', 'ratings')
                ->where('id', $assessorId)
                ->first();
    ...
    public function coachDetailById($coachId)
    {
        try {
            $CoachDetails = Coach::select('*')
                ->with(['coachReviews', 'coachEducations', 'WorkExperience'])
                ->withAvg('coachReviews', 'ratings')
                ->where('id', $coachId)
                ->first();
