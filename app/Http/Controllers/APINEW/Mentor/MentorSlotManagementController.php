...
use DB;
use Carbon\Carbon;
class MentorSlotManagementController  extends Controller
{
    use ApiResponse;
    ...
    public function mentorBookingSlotsCreationSubmit(Request $request)
    {
        try {
            ...
            return $this->successWithCmsResponse([
                ...
                'MentorAdditionalInfo' => $TrainersAdditionalInfo,
            ], ['image' => $image],'Mentor profile fetched successfully.');
