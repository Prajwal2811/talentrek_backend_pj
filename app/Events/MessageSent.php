...
class MessageSent implements ShouldBroadcast
{
    ...
    public function broadcastOn()
    {
        ...
        // 🔹 Web ke liye: guard based secure channel (per-user)
        if ($this->message->login_type === 'web') {
        ...
        // 🔹 App ke liye: role based public channel
        if ($this->message->login_type === 'app') {
            $channels[] = new Channel("chat.{$this->message->sender_type}");
            $channels[] = new Channel("chat.{$this->message->receiver_type}");
        }
