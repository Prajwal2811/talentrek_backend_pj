...
Route::prefix('trainer')->middleware('throttle:60,1')->group(function () {
    ...
    Route::get('/deleteTrainingMaterialById/{trainerId}', [TrainingController::class, 'deleteTrainingMaterialById']);
...
Route::get('/subscriptionPlanList/{type}/{userId}', [SessionsManagementController::class, 'subscriptionPlanListForMCAJT']);
