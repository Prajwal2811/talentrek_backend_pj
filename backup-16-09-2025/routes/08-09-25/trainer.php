...
Route::group(['prefix' => 'trainer'], function() {
    ...
    Route::middleware(['trainer.auth'])->group(function () {
        Route::get('/subscription', [TrainerController::class, 'showSubscriptionPlans'])->name('trainer.subscription.index');
        Route::post('/subscription-payment', [TrainerController::class, 'processSubscriptionPayment'])->name('trainer.subscription.payment');
    });

    // Routes requiring BOTH login & active subscription
    Route::middleware(['trainer.auth', 'check.trainer.subscription'])->group(function () {
