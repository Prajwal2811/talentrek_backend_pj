                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6">
                            <div class="container d-flex justify-content-center align-items-center min-vh-100">
                             <div class="w-full max-w-sm p-6">
                                ...
                                <form method="POST" action="{{ route('assessor.login.submit') }}">
                                    @csrf
                                    <div class="mb-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="text-right mt-1">
                                            <a href="{{ route('assessor.forget.password')}}" class="text-sm text-blue-600 hover:underline">Forgot password?</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="text-center text-sm">
                                        ...
                                        <a href="{{ route('assessor.signup')}}" class="text-blue-600 hover:underline">Sign up</a>
                                    </div>
                                </form>
