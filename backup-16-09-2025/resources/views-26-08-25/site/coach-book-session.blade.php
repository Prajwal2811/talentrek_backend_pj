                    ...
                    <section class="max-w-7xl mx-auto p-4">
                        <form method="POST" action="{{ route('coach-booking-submit') }}">
                            ...
                            <div class="grid grid-cols-2 gap-6 mb-6">
                                <div>
                                    <!-- < ?php echo "<pre>"; print_r($coachDetails);exit;?> -->
                                    <input type="hidden" name="coach_id" id="coachName" value="{{ $coachDetails->coach_id }}" />
                        ...
                        <script>
                            ...
                            function fetchSlots() {
                                ...
                                const coachId = document.getElementById('coachName').value;
                                ...
                                const url = `{{ route('get-coach-available-slots') }}?mode=${mode}&date=${date}&coach_id=${coachId}`;
