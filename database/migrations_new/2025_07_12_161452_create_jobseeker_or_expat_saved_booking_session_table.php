...
return new class extends Migration
{
    ...
    public function up()
    {
       Schema::create('jobseeker_or_expat_saved_booking_session', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('jobseeker_or_expat_id');
            $table->enum('role', ['jobseeker', 'expat'])->nullable();           // optional role field
            ...
            $table->string('track_id', 50)->nullable()->comment('Unique booking reference number');
            ...
            $table->decimal('slot_amount', 10, 2)->nullable();
