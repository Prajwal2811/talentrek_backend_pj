...
return new class extends Migration
{
    ...
    {
        Schema::create('jobseeker_and_expat_sessions_booking_payment_request', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('jobseeker_and_expat_sessions_booking_payment_request');
    }
};
