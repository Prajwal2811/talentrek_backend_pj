                        ...
                        <div class="row">
                            ...
                            <div class="container d-flex justify-content-center align-items-center min-vh-100">
                                <div class="w-full max-w-md px-6">
                                    ...
                                    <form class="space-y-4" action="{{ route('recruiter.register.post') }}" method="POST">
                                        @csrf 
                                        <div>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="phone_number" oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 10);" placeholder="Mobile Number" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600" value="{{ old('phone_number')}}">
                                        @error('phone_number')
                                            <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <!-- Register Button -->
                                    <button id="registerBtn" type="submit" disabled class="w-full bg-blue-700 text-white py-2 rounded-md opacity-50 cursor-not-allowed hover:bg-blue-800 transition">
                                        Register
                                    </button>
