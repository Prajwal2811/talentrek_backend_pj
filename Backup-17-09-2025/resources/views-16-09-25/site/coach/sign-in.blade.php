                                ...
                                <form method="POST" action="{{ route('coach.login.submit') }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="text-right mt-1">
                                            <a href="{{ route('coach.forget.password')}}" class="text-sm text-blue-600 hover:underline">Forgot password?</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="text-center text-sm">
                                        ...
                                        <a href="{{ route('coach.signup')}}" class="text-blue-600 hover:underline">Sign up</a>
                                    </div>
                                </form>
