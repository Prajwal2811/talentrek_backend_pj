                                ...
                                <form class="space-y-6" id="multiStepForm" action="{{ route('mentor.registration.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div id="step-1" class="step">
                                        ...
                                        <div>
                                            ...
                                            <div>
                                                <label class="block mb-1 text-sm font-medium mt-3" >{{ langLabel('national_id_number') }} <span style="color: red; font-size: 17px;">*</span></label>
                                    ...
                                    <div id="step-5" class="step hidden">
                                        ...
                                        {{-- <div>
                                            <label class="block text-sm font-medium mb-1">{{ langLabel('price_per_slot') }} <span style="color: red; font-size: 17px;">*</span></label>
                                        ...
                                        <div class="flex justify-between">
                                        <button type="button" onclick="showStep(4, false)" class="px-4 py-2 border rounded-md mt-3">{{ langLabel('back') }}</button>
