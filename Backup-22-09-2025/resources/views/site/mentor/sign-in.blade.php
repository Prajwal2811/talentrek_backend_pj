                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6">
                            <div class="container d-flex justify-content-center align-items-center min-vh-100">
                             <div class="w-full max-w-sm p-6">
                                ...
                                <form method="POST" action="{{ route('mentor.login.submit') }}">
                                    @csrf
                                    <div class="mb-4">
                                        <label for="email" class="block text-sm font-medium mb-1">{{ langLabel('email') }}</label>
                                        <input type="email" name="email" id="email" placeholder="{{ langLabel('email') }}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="text-right mt-1">
                                            <a href="{{ route('mentor.forget.password')}}" class="text-sm text-blue-600 hover:underline">{{ langLabel('forgot_password') }}</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="text-center text-gray-400 text-sm mb-3">- {{ langLabel('or') }} -</div>

                                    <div class="text-center text-sm">
                                        {{ langLabel('no_account') }}
                                        <a href="{{ route('mentor.signup')}}" class="text-blue-600 hover:underline">{{ langLabel('register') }}</a>
                                    </div>
                                </form>
